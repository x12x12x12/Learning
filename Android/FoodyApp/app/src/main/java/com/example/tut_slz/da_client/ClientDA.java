...
import ServerInfo.RemoteServer;
...
public class ClientDA extends TabActivity {
    ...
    public static RemoteServer rsInfo=new RemoteServer();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbMain.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                if(3 == tbMain.getCurrentTab()){
                    if(true == Bill.bChanged){
                        Bill.Refresh();
                    }
                }
            }
        ...
        //bill
        intent=new Intent(ClientDA.this,Bill.class);
        tSpec=tbMain.newTabSpec("bill").setIndicator("Bill").setContent(intent);
        tbMain.addTab(tSpec);


        tbMain.setCurrentTab(1);
    }
